...
class Opleidingen(models.Model):
    opleiding_id = models.AutoField(db_column='Opleiding_id', primary_key=True)  # Field name made lowercase.
    startjaar = models.TextField(db_column='Startjaar')  # Field name made lowercase. This field type is a guess.
    eindjaar = models.TextField(db_column='Eindjaar', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
    opleiding = models.CharField(db_column='Opleiding', max_length=80)  # Field name made lowercase.
    document = models.CharField(db_column='Document', max_length=80, blank=True, null=True)  # Field name made lowercase.
