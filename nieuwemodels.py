...
class Activiteit(models.Model):
    startdatum = models.ForeignKey('Functie', models.DO_NOTHING, db_column='StartDatum', primary_key=True)  # Field name made lowercase.
...
class Functie(models.Model):
    startdatum = models.ForeignKey('Opdracht', models.DO_NOTHING, db_column='StartDatum', primary_key=True)  # Field name made lowercase.
